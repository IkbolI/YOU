        ...
        game.child("Yes").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    UserAdapter yesAdapter = new UserAdapter(GamePage5.this, userListYes);
        ...
        game.child("Maybe").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    UserAdapter maybeAdapter = new UserAdapter(GamePage5.this, userListMaybe);
        ...
        game.child("No").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    UserAdapter noAdapter = new UserAdapter(GamePage5.this, userListNo);
        ...
        game.child("Comment").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    CommentAdapter adapter = new CommentAdapter(GamePage5.this, commentList);
