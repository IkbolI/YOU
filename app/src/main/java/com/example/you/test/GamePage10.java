...
public class GamePage10 extends AppCompatActivity implements View.OnClickListener {
    ...
    final DatabaseReference game = db.getReference("GameMain").child("GP10");
...
//                break;
    ...
    public void btnNextClick () {
        startActivity(new Intent(GamePage10.this, GamePage11.class));
        ...
        game.child("Yes").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    UserAdapter yesAdapter = new UserAdapter(GamePage10.this, userListYes);
        ...
        game.child("Maybe").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    UserAdapter maybeAdapter = new UserAdapter(GamePage10.this, userListMaybe);
        ...
        game.child("No").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    UserAdapter noAdapter = new UserAdapter(GamePage10.this, userListNo);
        ...
        game.child("Comment").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    CommentAdapter adapter = new CommentAdapter(GamePage10.this, commentList);
