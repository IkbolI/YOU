...
public class GamePage1 extends AppCompatActivity implements View.OnClickListener {
    ...
    final DatabaseReference game = db.getReference("GameMain").child("GP1");
        ...
        game.child("Yes").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    UserAdapter yesAdapter = new UserAdapter(GamePage1.this, userListYes);
        ...
        game.child("Maybe").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    UserAdapter maybeAdapter = new UserAdapter(GamePage1.this, userListMaybe);
        ...
        game.child("No").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    UserAdapter noAdapter = new UserAdapter(GamePage1.this, userListNo);
        ...
        game.child("Comment").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    CommentAdapter adapter = new CommentAdapter(GamePage1.this, commentList);
...
//        void onCallback (UserModel list);
//    }
//
//    private interface FirebaseCallbackComment {
//        void onCallback (Comment list);
//    }
}
