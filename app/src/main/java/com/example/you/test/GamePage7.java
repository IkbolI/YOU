...
public class GamePage7 extends AppCompatActivity implements View.OnClickListener {
    ...
    final DatabaseReference game = db.getReference("GameMain").child("GP7");
        ...
        game.child("Yes").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    UserAdapter yesAdapter = new UserAdapter(GamePage7.this, userListYes);
        ...
        game.child("Maybe").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    UserAdapter maybeAdapter = new UserAdapter(GamePage7.this, userListMaybe);
        ...
        game.child("No").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    UserAdapter noAdapter = new UserAdapter(GamePage7.this, userListNo);
        ...
        game.child("Comment").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    CommentAdapter adapter = new CommentAdapter(GamePage7.this, commentList);
